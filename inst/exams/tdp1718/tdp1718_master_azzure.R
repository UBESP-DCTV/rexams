...
death_ita[[1]] <- toupper(death_ita[[1]])
...
#'
#' Produrre due dataframe, nominati rispettivamente `bot_fan_2000` e
#' `bot_fan_2016`, riportanti il primo i soli dati riferiti all'anno 2000 e ai
#' fanciulli, ordinati dalla causa più meno frequente alla più frequente, il
#' secondo analogo ma per i dati del 2016.
#'
#'<!-- ===================================================================== -->


bottomup <- death_ita[order(death_ita$percentuale), ]

bot_fan_2000 <- bottomup[bottomup$mesi == 'fanciullo' & bottomup$anno == 2000, ]
bot_fan_2016 <- bottomup[bottomup$mesi == 'fanciullo' & bottomup$anno == 2016, ]
...
#'
#' A partire dai due dataset creati alla domanda 10 (ovvero `bot_fan_2000` e
#' `bot_fan_2016`) creare due grafici distinti (ma del tutto analoghi) in cui si
...
only_bot_2000 <- death_ita[
  death_ita$causa_del_decesso %in% bot_fan_2000[['causa_del_decesso']][1:3],
]
...
only_bot_2016 <- death_ita[
  death_ita$causa_del_decesso %in% bot_fan_2016[['causa_del_decesso']][1:3],
]
xyplot(percentuale ~ anno | mesi,
       groups = causa_del_decesso,
       data   = only_bot_2016,
